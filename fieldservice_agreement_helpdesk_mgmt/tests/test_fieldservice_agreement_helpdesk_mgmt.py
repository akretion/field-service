...
class TestFieldserviceAgreementHelpdeskMgmt(common.TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_create_fsm_order(self):
        ...
        self.assertEqual(
            action_create_order["context"]["default_agreement_id"], self.agreement.id
        )
